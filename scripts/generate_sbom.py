...
out={'bomFormat':'CycloneDX','specVersion':'1.5','version':1,'metadata':{'component':{'type':'application','name':'project-xray-india','version':'0.4.8'},'properties':[{'name':'runtime.python','value':platform.python_version()},{'name':'dependencies.third_party_runtime','value':'psycopg2-binary (optional, PostgreSQL mode)'}]},'components':[],'properties':[{'name':'project.files','value':json.dumps(files,separators=(',',':'))}]}
